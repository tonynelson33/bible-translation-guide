...
export const rankingCategories: RankingCategory[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "ehv", blurb: "Its heavy footnoting — alternate renderings, textual notes, cross-references — was a stated design goal, and makes it a stronger study text than its small ecosystem suggests." },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "ehv", blurb: "Designed by its Lutheran translators for the pulpit and the pew, balancing accuracy with language that reads well aloud; standard in WELS and ELS churches." },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "nkjv", blurb: "The most even spread on the page: 4th to 7th in all four categories, without ever leading one." },
      ...
      { id: "ehv", blurb: "No standout finish and no disaster — 6th to 9th across all four categories." },
      { id: "kjv", blurb: "Its #1 finish for memorization is a genuine strength; the older text and archaic English put it in the bottom third for study, devotions, and preaching." },
      { id: "ceb", blurb: "A strong 2nd for daily devotions, but the plain, loose phrasing costs it badly for study (12th) and memorization (10th)." },
