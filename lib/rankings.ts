export interface RankingEntry {
  ...
  id: string;
  /** Rationale — fuller for the top 3 (shown as gold/silver/bronze), a single short sentence for 4-13. */
  blurb: string;
}
...
export interface RankingCategory {
  ...
  criteria: string;
  /** All 13 translations, ranked best to worst for this criterion. */
 ...
 *
 * NRSV, CEB, EHV, and AMP were added 2026-09-06. In the six descriptive
 * categories the existing nine keep their relative order — the four new
 * translations were only slotted in. "Best Overall Balance" is computed from
 * the other lists, so it shifts a little.
 */
export const rankingCategories: RankingCategory[] = [
  {
    ...
    entries: [
      ...
      { id: "ehv", blurb: "The smallest footprint on this list — used mainly in the roughly 1,500 WELS and ELS congregations it was made for." },
    ],
    note: "Positions 1-6 follow ECPA's 2024 year-end bestseller list in order (NIV, ESV, KJV, NLT, NKJV, CSB). Everything below that — NASB, NRSV, AMP, LSB, CEB, NET, EHV — blends occasional bestseller-list appearances with overall real-world use and is less precisely documented. Exact order also shifts month to month, so treat this as a general picture rather than a fixed, permanent order.",
  },
  {
    slug: "literal",
    ...
    entries: [
      ...
      { id: "ehv", blurb: "Its “balance” philosophy is the same middle path as the CSB — leaning formal or dynamic verse by verse — with a slightly more traditional hand on vocabulary." },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "ehv", blurb: "Its heavy footnoting — alternate renderings, textual notes, cross-references — was a stated design goal, and makes it a stronger study text than its tiny ecosystem suggests." },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "ehv", blurb: "Contemporary and clear, a little more formal in its sentences than the CSB or NIV — an easy read without feeling loose." },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "ehv", blurb: "Built by its translators for the pulpit and the pew — accurate but easy to read aloud. It delivers on the brief; it's just little used outside WELS and ELS churches." },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "ehv", blurb: "Consistent, moderately formal wording that lends itself to memory work — now the standard for Scripture memory in WELS and ELS schools, though that tradition is young." },
    ...
    entries: [
      {
        id: "esv",
        blurb:
          "The best average across the four use cases — 2nd for preaching, 3rd for memorization, 4th for serious study, and no worse than 8th (daily devotions). No single specialty, and no real weakness.",
      },
      {
        id: "csb",
        blurb:
      ...
      },
      {
        id: "nasb",
        blurb:
          "2nd for both serious study and memorization on the strength of its precision; an 11th-place finish for daily devotions is all that keeps it off the very top.",
      },
      ...
      { id: "nrsv", blurb: "Carried by a 3rd for serious study and a 4th for preaching; the formal register and inclusive-language phrasing land it 9th for both personal reading and memorization." },
      { id: "kjv", blurb: "A clear #1 for memorization and 7th for preaching, weighed against 9th for study and 10th for daily reading — the archaic text is the drag on the everyday-use side." },
      { id: "net", blurb: "The #1 translation for serious study, but 12th for both preaching and memorization — the notes that make it exceptional don't help when the text is read aloud." },
      { id: "ceb", blurb: "A strong 2nd for daily devotions carries an otherwise low set of finishes — 9th to 12th in the other three." },
      { id: "lsb", blurb: "5th for study and 6th for memorization on the back of its precision, but 10th to 12th for the two most public-facing uses." },
      { id: "ehv", blurb: "Capable across the board and distinctive nowhere — 7th for daily devotions is its best finish, and everywhere else it's 8th to 10th." },
      ...
      { id: "amp", blurb: "A reference tool rather than an everyday Bible — last in three of the four categories, and 11th in the other." },
    ],
