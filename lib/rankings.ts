...
export const rankingCategories: RankingCategory[] = [
  ...
  },
  {
    ...
    note: "This mostly follows each translation's own stated philosophy — the Formal / Optimal / Mixed / Dynamic field in the comparison table — plus the broad agreement of published “translation spectrum” charts. The tiers are well settled; the order within each is finer judgment. AMP and NRSVue are genuine edge cases (see their entries), the NET is placed by how its readable main text lands rather than by its “Mixed” label, and the NIrV tracks the NIV rather than reading more freely since it's the same underlying text at a simpler vocabulary. “More literal” describes a method, not accuracy or quality — everything here is a real translation by competent scholars. The Message isn't on this list at all: it's a genuine paraphrase, not positioned on the Formal-to-Dynamic axis the rest of this ranking measures — see its own profile.",
  },
  {
    slug: "memorization",
