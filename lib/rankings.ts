...
export const rankingCategories: RankingCategory[] = [
  {
    ...
    entries: [
      {
        id: "niv",
        blurb:
          "The best-selling modern English translation for most of the past several decades, and still a regular #1 or near-#1 on ECPA's monthly Christian-retail bestseller charts.",
      },
      {
        id: "esv",
        blurb:
          "A fixture near the top of the charts for years, especially strong in Reformed and broadly evangelical retail.",
      },
      {
        id: "kjv",
        blurb:
          "The best-selling Bible translation of all time by a wide margin, thanks to a 400-year head start and being fully public domain — and still a strong, steady seller in Christian retail today.",
      },
      { id: "nlt", blurb: "One of the fastest-growing translations in recent years — by some 2025-2026 Christian-retail measures it has actually pulled ahead of the NIV in unit sales, a genuine and closely watched shift rather than a settled ranking." },
      { id: "nkjv", blurb: "A perennial top-five seller, popular with readers who want the King James tradition in modern grammar." },
      { id: "csb", blurb: "One of the fastest-growing translations in recent years, and a regular presence on ECPA's monthly top-ten list." },
      { id: "nasb", blurb: "A perennial top-ten seller in Christian retail, even though its audience is more specialized than the translations above it." },
      { id: "nrsvue", blurb: "Doesn't drive much activity on an evangelical-retail-weighted chart like ECPA's, but has a much larger everyday footprint across seminaries, universities, and mainline pews than any retail measure would suggest." },
      ...
      { id: "gnt", blurb: "Historically one of the best-selling English Bibles of the 20th century — over 244 million copies distributed since 1966 — though its current ECPA print-chart presence is a shadow of that peak; strongest today in literacy and outreach ministry rather than general retail." },
      { id: "nirv", blurb: "Not a general-market bestseller, but a real and durable presence in children's ministry and ESL Bible study — the NIV's own familiar text reaching a market the adult retail charts don't measure." },
    ...
    note: "NIV, ESV, KJV, NLT, NKJV, CSB, and NASB are the translations most consistently near the top of ECPA's monthly Christian-retail bestseller charts (compiled from Circana BookScan data), with one or two Spanish-language translations — not profiled on this site — regularly in the same top ten. That cluster isn't a fixed order: it shifts from month to month, and the NIV/NLT position specifically has been a genuine, closely watched race rather than a settled ranking. NRSVue and NIrV are real, significant translations by other measures (seminary and mainline-church use for the NRSVue, children's and ESL ministry for the NIrV) that don't show up the same way on an evangelical-retail-weighted chart, which is why they're placed by that different evidence rather than a chart position. Everything below the top cluster here blends real but differently-shaped usage evidence — readership surveys, digital-download counts, app rankings, historical print totals, denominational and ministry footprints — since most of these translations are free, digital-first, or otherwise outside the print-retail channel ECPA's chart measures; each entry's blurb says what kind of evidence it's actually resting on.",
  },
  {
    slug: "literal",
  ...
  },
  {
    ...
    entries: [
      ...
      {
        id: "gw",
        blurb: "A 5th-grade level achieved through natural English rhythm and phrasing, not just simple vocabulary — genuinely easy to sit and read.",
      },
      {
        id: "ceb",
      ...
      {
        id: "gnt",
        blurb: "Built from the ground up as a “common language” translation — plain enough for non-native speakers and readers with little church background, at a 7th-grade level.",
      },
      {
        id: "nirv",
      ...
      { id: "web", blurb: "A formal, ASV-descended reading level (12th grade, tied with the KJV) — the densest translation on this list after the KJV itself, and denser than any of the Dynamic or Optimal translations above it." },
      ...
      { id: "mev", blurb: "A denser daily read than its KJV-tradition cousin the NKJV — fully contemporary grammar doesn't change that it measures closer to the NASB's 11th-grade level than the NKJV's 7th." },
    ...
    entries: [
      {
        id: "esv",
        blurb:
          "The best average across the four use cases — 2nd for preaching, 3rd for memorization, 4th for serious study, and no worse than 15th (daily devotions, where formal translations generally sit lower). No single specialty, and no real weakness.",
      },
      {
        id: "csb",
        blurb:
      ...
      },
      {
        id: "nasb",
        blurb:
          "2nd for memorization and 3rd for serious study on the strength of its precision; a 19th-place finish for daily devotions is what keeps it off the very top.",
      },
      ...
      { id: "kjv", blurb: "A clear #1 for memorization and 7th for preaching, weighed against weaker 17th and 14th finishes for devotions and study — the archaic text is the drag on the everyday-use side." },
      { id: "nrsvue", blurb: "Carried by a 4th for preaching, the mainline lectionary Bible, and a 7th for serious study; the formal register and inclusive-language phrasing land it lower — 16th and 12th — for personal reading and memorization." },
      { id: "mev", blurb: "A real 5th-place finish for memorization on the strength of its formal, KJV-adjacent cadence, but too new for an established tradition in preaching or study — and its true reading level (11th grade, on par with the NASB) makes daily devotions its weakest showing by far, not a middling one." },
      ...
      { id: "gnt", blurb: "6th for daily devotions on real oral-clarity credentials, but its willingness to paraphrase for plain clarity costs it everywhere else — 14th to 23rd across the other three." },
      ...
      { id: "ncv", blurb: "A strong 3rd for daily devotions from its plain, 5th-grade prose, but 15th to 22nd everywhere else." },
      ...
      { id: "gw", blurb: "A real 4th for daily devotions from its natural, easy phrasing, but 16th to 20th elsewhere." },
