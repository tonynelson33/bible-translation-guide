...
export const translationProfiles: Partial<Record<string, TranslationProfile>> = {
  ...
  niv: {
    ...
    overview: [
      ...
      "On gender language, the current NIV takes a moderate approach: where the original clearly addresses or describes both men and women, it uses inclusive wording — “brothers and sisters” for the Greek adelphoi, generic “man” rendered “people” or “human beings” — while keeping masculine language for God and wherever the text is gender-specific. The 2011 edition recasts generic singular pronouns as plurals more often than the NLT or CSB do, which is what drew formal opposition from some conservative groups; it stops short of the more thorough approach in the NRSVue.",
  ...
  nrsvue: {
    tagline:
      "The 2021 Updated Edition of the NRSV — the formal, inclusive-language translation standard across mainline Protestant churches and academic biblical studies.",
    overview: [
      "The New Revised Standard Version, Updated Edition (NRSVue) is the 2021 revision of the NRSV, published by the National Council of Churches. The NRSV itself appeared in 1989, as a revision of the 1952 Revised Standard Version — in the lineage that runs back through the 1901 American Standard Version to the King James Version. Its committee was chaired by the textual critic Bruce Metzger of Princeton and included Protestant, Roman Catholic, Eastern Orthodox, and Jewish scholars, one of the most broadly ecumenical teams ever assembled for an English Bible.",
      "The Updated Edition, overseen by the Society of Biblical Literature, folded in three decades of manuscript discoveries and scholarship, refined the inclusive-language renderings, and adjusted several thousand verses. The NCC treats it as the current NRSV, and Bible Gateway and most publishers now serve the updated text under the plain name “NRSV.” The verses and data on this site are the NRSVue. Adoption in worship has been gradual, though — many mainline lectionaries still use the 1989 text — so a church that says it uses “the NRSV” may mean either edition.",
      "Its guiding rule, inherited from the RSV, is “as literal as possible, as free as necessary” — a formal-equivalence approach that stays close to the structure of the Hebrew, Aramaic, and Greek, though less rigidly word-for-word than the NASB or ESV. It translates from the standard Critical Text, and where the Dead Sea Scrolls or the Septuagint preserve an older or clearer reading than the traditional Masoretic Hebrew, it often follows them and notes the change in the margin.",
      "The NRSV was the first major English translation to make gender-inclusive language for humanity a standing policy: where the original clearly addresses or describes both men and women, it renders the text “brothers and sisters,” “friends,” or “people” rather than “brothers” or “men.” Traditional masculine language for God is kept, and pronouns for God are not capitalized — a deliberate choice, since the original languages draw no such distinction. For a generation it has been the assumed common text of Protestant seminaries and academic biblical scholarship, and the base for study Bibles like the New Oxford Annotated Bible; it is the approved lectionary translation across most of mainline Protestantism, and is also published in a Catholic edition with the deuterocanonical books.",
    ],
    distinctives: [
      "The current edition of the NRSV — most publishers and Bible Gateway now serve this 2021 text under the plain name “NRSV,” though many lectionaries still use the 1989 edition.",
      ...
      "The standard translation of academic biblical studies and mainline seminaries; also published in a Catholic edition with the deuterocanonical books.",
    ],
    goodFor: [
      "Mainline Protestant worship and study — the NRSV family is the pew and lectionary Bible in the Episcopal, ELCA, PC(USA), UMC, UCC, and Disciples traditions.",
  ...
  amp: {
    ...
    overview: [
      ...
      "The Lockman Foundation substantially revised the Amplified Bible in 2015, updating the base translation and standardizing the bracket system so it is easier to follow. The base text is formal-equivalence and translates from the standard Critical Text; the amplifications are the added layer.",
  ...
  gw: {
    tagline: "A \"closest natural equivalence\" translation built to avoid both stiff literalism and loose paraphrase.",
    overview: [
    ...
    goodFor: [
      "Readers who want an easy, natural-sounding reading experience without moving to a paraphrase like The Message.",
      "New believers and casual readers who want plain modern English translated fresh from the original languages.",
  ...
  voice: {
    ...
    overview: [
      ...
      "On gender language, The Voice takes an inclusive approach, translating generic references to people in ways that read naturally in contemporary English rather than defaulting to generic masculine terms — consistent with its broader goal of a fresh, conversational voice rather than a formal, traditional register.",
    ],
    distinctives: [
