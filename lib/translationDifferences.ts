    ...
    sections: [
      ...
      },
      {
        ...
        shown: [
          ...
          { reference: "Mark 7:16", show: ["kjv"], note: "A refrain that appears many times elsewhere in the Gospels." },
          ...
          { reference: "Romans 16:24", show: ["kjv"], note: "A grace-benediction repeating the one in verse 20." },
        ],
      },
      {
        id: "phrases",
