...
export const metadata: Metadata = {
  title: "Church Finder",
  description:
    "Search 368,000+ U.S. Christian churches by city or zip and see which Bible translation each one uses. Covers the historic traditions — Catholic, Orthodox, and Protestant.",
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <p className="mt-3 max-w-3xl text-neutral-600">
        Search over 368,000 U.S. churches by name, denomination, city, or zip code. Where we&apos;ve confirmed which
