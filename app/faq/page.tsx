...
export const metadata: Metadata = {
  ...
  description:
    "Straight answers to the common questions about English Bible translations — the most accurate translation, why there are so many, whether modern Bibles removed verses, KJV-onlyism, paraphrases, and the manuscripts behind the text.",
