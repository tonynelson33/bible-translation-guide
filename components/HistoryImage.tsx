 ...
 * each image a little so five sources from five centuries sit together and read
 * as archival rather than as stock photos. See lib/englishBibleHistory.ts for
 * the image data and provenance.
 */
